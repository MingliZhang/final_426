...
const handelLoginButtonPress = function (event) {
    ...
    if (email.length !== 0 && password1.length !== 0 && ValidateEmail(email) && password2.length !== 0 && password1 === password2 ){
        window.location.href = "../test.html?email=" + email + "&password=" + password1;
    }else{
        let message = "";
