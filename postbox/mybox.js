...
const loadHeaderIntoDom = async function(){
    ...
    let postHeader = `
        <div class = "header">
            ...
            <button type = "button" class = "button" id = "create"><i class="fas fa-pen-square" style = "color: #FFA883"></i>Create My Mailbox</button>
        </div>`;
...
const handleCreateButtonPress = function(event){
    ...
    let form = `
        <form class = "newPost card post">
            <textarea name = "bodytext" class = "textarea newPostText">Hi everyone! Welcome to my mailbox</textarea>
